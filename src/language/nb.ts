export const nb = {
    ...
    tilleggsopplysninger: 'Velg hvilke tilleggsopplysninger du vil skrive ut',
    type: 'Type',
    typearbeidsforhold: 'Type arbeidsforhold',
    utskriftsvalg: 'Utskriftsvalg',
    ...
    pdfFooter2: (date: string) => `Arbeids- og velferdsetaten // Utskrift fra ${date}`,
