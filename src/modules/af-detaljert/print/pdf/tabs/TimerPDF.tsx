...
export const TimerPDF = (props: Props) => {
    ...
    props.timer.sort((left, right) => sortPeriodeFraDesc(left.periode, right.periode));
                                ...
                                <View key={`${i}`} style={pdfStyles.flexRow}>
                                    <View style={pdfStyles.flexColumn}>
                                        <Text style={pdfStyles.normaltekst}>
                                            {time.periode && <CheckDateAndPrint data={time.rapporteringsperiode} dateFormat="MMMM" />}
                                        </Text>
                                    </View>
                                    <View style={pdfStyles.flexColumn}>
                                        <Text style={pdfStyles.normaltekst}>
